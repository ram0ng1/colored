...
// Track last applied color so we only suppress transitions on actual color changes,
// not on every Mithril redraw (which would kill search/other animations mid-flight).
